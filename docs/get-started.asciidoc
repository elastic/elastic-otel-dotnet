...
If you need more control over your configuration after getting set up, you can learn more in the https://opentelemetry.io/docs/languages/net[OpenTelemetry SDK documentation].
...
. In {kib}, go to *Observability* → *Applications* → *Traces*.
...
. Click on the name of the service in the list to see traces.
+
