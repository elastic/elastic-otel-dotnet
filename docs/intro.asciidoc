...
✅ Why use it?
////
A _distribution_ is a customized version of an upstream OpenTelemetry repository with some customizations. The {distro_name} is an extension of the https://opentelemetry.io/docs/zero-code/net/configuration/[OpenTelemetry SDK for {language}] and includes the following customizations:
