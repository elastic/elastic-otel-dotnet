...
internal static partial class LoggerMessages
{
	...
	[LoggerMessage(EventId = 11, EventName = "HttpInstrumentationFound", Level = LogLevel.Debug, Message = "The HTTP instrumentation library was located at '{AssemblyPath}'. " +
	...
	[LoggerMessage(EventId = 12, EventName = "SignalDisabled", Level = LogLevel.Information, Message = "Skipping configuring and setting EDOT defaults for {Signal}, as these have been disabled via configuration.")]
	public static partial void LogSignalDisabled(this ILogger logger, string signal);

	[LoggerMessage(EventId = 13, EventName = "ProviderBuilderSignalDisabled", Level = LogLevel.Information, Message = "Skipping configuring and setting EDOT defaults for {Signal} on {ProviderBuilderType}, " +
	...
	[LoggerMessage(EventId = 14, EventName = "SkippingBootstrap", Level = LogLevel.Warning, Message = "Skipping EDOT bootstrap and provider configuration because the `Signals` configuration is set to `None`. " +
